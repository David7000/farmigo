...
<!-- Mirrored from www.farmigo.com/about/jobs by HTTrack Website Copier/3.x [XR&CO'2010], Sat, 25 Jun 2016 16:54:55 GMT -->
...
<body id="page-about" class="not-mobile desktop jobs-tab">
...
<section class="banner-section">
    <h2>Be a part of Farmigo's next chapter</h2>
</section>
...
<script src='../../www.workable.com/assets/embed.js' type='text/javascript'></script>
<script type='text/javascript' charset='utf-8'>
	whr(document).ready(function(){
		whr_embed(9659, {detail: 'titles', base: 'departments', zoom: 'city'});
	});
</script>

<section class="content-section centered group">
