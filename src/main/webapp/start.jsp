...
<!-- Mirrored from www.farmigo.com/start by HTTrack Website Copier/3.x [XR&CO'2010], Sat, 25 Jun 2016 16:54:11 GMT -->
...
<script>
	...
	Farmigo.common.data.page = 'Start';
...
<script>
	...
	Farmigo.com.data.currentPage = 'start';
</script>
...
<body id="page-start" class="not-mobile desktop ">
            ...
            <div class="help-tab">
                <div class="help-links">
                    <ul class="links dynamic">
                                ...
                                <li>
                                    <a href="http://help.farmigo.com/hc/en-us/articles/200549849-What-does-an-Organizer-do-" target="_blank">What does an Organizer do?</a>
                                </li>
...
<div class="page-start">
	<section class="banner-section banner-section-with-forms">
            ...
            <div class="forms">
                <div class="message">
                    <div class="top">
                            ...
                            <h1>Local food is<br/>better for all of us.</h1>
                            <h2><em>Become a Farmigo Organizer</em> to<br/>bring the <em>best food ever</em> from<br/><em>local farmers and producers</em><br/>to your <em>community.</em></h2>
                            <a class="learn-more hidden-xs" type="vimeo" videoId="101851606">
                                <span>Learn  more about<br/>being an Organizer</span>
                                <i></i>
                            </a>
                            ...
                            <div class="fields">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="phone form-field">
                                            ...
                                            <input type="text" id="phoneNumber" form-type="phone" placeholder="e.g. 617-555-1234" error="Please enter a valid number" mandatory/>
                                        </div>
                                ...
                                <div class="form-field">
                                    ...
                                    <div class="form-field group">
                                        <label for="organizerReason">Why do you want to start a Farmigo Community?</label>
                                        <textarea id="organizerReason" mandatory></textarea>
                                    </div>
        ...
        <section class="learn-more-section visible-xs">
            <div class="centered">
                <a class="learn-more" type="vimeo" videoId="101851606">
                    <span>Learn  more about<br/>being an Organizer</span>
                    <i></i>
                </a>
            </div>
        ...
        <section class="organizers-do-section">
            <div class="centered">
                <h1>What do Organizers do?</h1>
                <p class="intro">It’s easy. Share your passion for good food by finding a spot to host a weekly pick-up (any bit of space will do) for a few hours a week.</p>
                <ul>
                    
                    <li >
                        <figure>
                            <img src='site/farmigo.com/images/start/organizers-do1d3d7.svg?2016-06-24-2230'/>
                            <figcaption>
                                <p class="big">Start by <em>finding friends, family members, and neighbors</em> who are interested in a new way to eat, and encourage them to join your Farmigo Food Community and place orders!</p>
                            </figcaption>
                        </figure>
                    </li>
                    ...
                    <li >
                        <figure>
                            <img src='site/farmigo.com/images/start/organizers-do2d3d7.svg?2016-06-24-2230'/>
                            <figcaption>
                                <p class="big"><em>Oversee the weekly <span class='no-wrap'>farm-fresh</span> delivery to your selected site</em> (at a time of your choosing) and facilitate the community pick-ups.</p>
                            </figcaption>
                        </figure>
                    </li>
                    ...
                    <li >
                        <figure>
                            <img src='site/farmigo.com/images/start/organizers-do3d3d7.svg?2016-06-24-2230'/>
                            <figcaption>
                                <p class="big"><em>Keep your community thriving!</em> After your first pickup, maintain an active role in continuing to grow your Farmigo community.</p>
                            </figcaption>
                        </figure>
                    </li>
                    ...
                    <li class="wide">
                        <figure>
                            <img src='site/farmigo.com/images/start/organizers-do4d3d7.svg?2016-06-24-2230'/>
                            <figcaption>
                                <p class="big"><em>We’ll be here to support you every step of the way!</em> You’ll have a dedicated community team member and in-person support, a custom materials toolkit, and dedicated support hotline. We’re always here to provide resources and help you grow and maintain your Community.</p>
                            </figcaption>
                        </figure>
                    </li>
            ...
            <ul>
                ...
                <li >
                    <figure>
                        ...
                        <figcaption>
                            <p class="big"><em>Community members order amazing local food in our online marketplace:</em> fresh produce, eggs and dairy, meats and seafood, breads, pasta, and more!</p>
                        </figcaption>
                    </figure>
                </li>
                ...
                <li >
                    <figure>
                        ...
                        <figcaption>
                            <p class="big">On delivery day, <em>friends and neighbors pick up their groceries at your community!</em></p>
                        </figcaption>
                    </figure>
                </li>
            ...
            <ul>
                ...
                <li>
                    <figure>
                        ...
                        <figcaption>
                            <h3>Do Good and Save</h3>
                            <p class="big"><em>20% off your own groceries</em>, plus additional compensation based on the strength of your community.</p>
                        </figcaption>
                    </figure>
                </li>
    ...
    <section class="testimonials-section">
        <div class="centered">
                ...
                <h1>Who are Organizers?</h1>
                <p class="intro">All you need to be an Organizer is a <br class="visible-xs"/><em>passion for good food.</em></p>
                <p class="big">We have Organizers of all types, ranging from business owners and health coaches to yoga instructors and stay-at-home parents. You can either start a pick-up yourself, or start one with a friend.</p>
                <p class="big">See what they have to say:</p>
            ...
            <ul class="group">
                ...
                <li>
                    <img src='site/farmigo.com/images/start/alissa-stoltzd3d7.jpg?2016-06-24-2230'/>
                    <blockquote>
                        <h3 class="quotee">Alissa Stoltz</h3>
                        <h4 class="quotee-title">Nutrition Coach and Cooking Instructor</h4>
                        <h4 class="address">Livingston, NJ</h4>
                        <p class="quote">&ldquo;Being an Organizer has been an amazing way to enjoy delicious, local food and connect with neighbors and friends.  It's such an easy way to support the kind of food system I believe in.&rdquo;</p>
                    </blockquote>
                    
                </li>
                
                <li>
                    <img src='site/farmigo.com/images/start/matthew-slutskyd3d7.jpg?2016-06-24-2230'/>
                    <blockquote>
                        <h3 class="quotee">Matthew Slutsky</h3>
                        <h4 class="quotee-title">Director of Partnerships and Henry's Dad</h4>
                        <h4 class="address"></h4>
                        <p class="quote">&ldquo;I was worried that being a Farmigo organizer would be too much to handle. I was wrong. It has added so much to our lives -- excellent food, a deep connection with our neighbors, and a satisfaction knowing we're helping local farmers and producers.&rdquo;</p>
                    </blockquote>
        ...
        <section class="listed-faq-section">
            <div class="centered group">
                <h1>Frequently Asked Questions</h1>
                <ul class="sub-sections group">
                    
                        <li>
                            <h3>Being an Organizer</h3>
                            <ul class="sub-section">
                                
                                    <li>
                                        <a href="http://help.farmigo.com/hc/en-us/articles/200940435-I-am-interested-in-becoming-a-Farmigo-Organizer-and-starting-my-own-food-Community-How-do-I-get-started-" target="_blank" data-subsection="Being an Organizer">I am interested in becoming a Farmigo Organizer, and starting my own food Community. How do I get started?</a>
                                    </li>
                                
                                    <li>
                                        <a href="http://help.farmigo.com/hc/en-us/articles/200549849-What-does-an-Organizer-do-" target="_blank" data-subsection="Being an Organizer">What does an Organizer do?</a>
                                    </li>
                                
                                    <li>
                                        <a href="http://help.farmigo.com/hc/en-us/articles/201245205-What-is-the-weekly-time-commitment-for-being-an-Organizer-" target="_blank" data-subsection="Being an Organizer">What is the weekly time commitment for being an Organizer?</a>
                                    </li>
                        ...
                        <li>
                            <h3>Starting a Community</h3>
                            <ul class="sub-section">
                                
                                    <li>
                                        <a href="http://help.farmigo.com/hc/en-us/articles/200800859-Where-can-I-host-a-pickup-site-" target="_blank" data-subsection="Starting a Community">Where can I host a pickup site?</a>
                                    </li>
                                
                                    <li>
                                        <a href="http://help.farmigo.com/hc/en-us/articles/201245975-How-much-space-is-needed-for-a-pickup-site-" target="_blank" data-subsection="Starting a Community">How much space is needed for a pickup site?</a>
                                    </li>
                                
                                    <li>
                                        <a href="http://help.farmigo.com/hc/en-us/articles/200800839-What-is-the-best-way-to-recruit-community-members-" target="_blank" data-subsection="Starting a Community">What is the best way to recruit community members?</a>
                                    </li>
