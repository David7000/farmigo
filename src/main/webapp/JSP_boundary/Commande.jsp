                    ...
                    <div class="navbar navbar-fixed-top" role="navigation">
                        <div class="container">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li class="learn-more dropdown">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li>
                                                <a class="faq" href="Commande.jsp" target="_self" data-analytics-category="header" data-analytics-action="vos commandes">vos commandes</a>
                                            </li>  

                                            <li>                                               
                                                <a class="faq" href="mail_form.jsp" target="_self" data-analytics-category="header" data-analytics-action="contact">contact</a>
                                            </li>                                          
                            ...
                            <ul class="main-nav nav navbar-nav navbar-right">
                                ...
                                <li class="">
                                    <a  href="Producteur_Farmigo Food Community.jsp"  class="market nav-option ">
                                        <div>
                                            <i class="hidden-xs"></i>
                                ...
                                <li class="">
                                    <a href="Market_Farmigo Food Community.jsp" class="market nav-option ">
                                        <div>
                                            <i class="hidden-xs"></i>
