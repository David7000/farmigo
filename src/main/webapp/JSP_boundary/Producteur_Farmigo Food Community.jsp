...
<html page="market" class="farmigo market-new"><head>
        ...
        <!--Producteur_Farmigo Food Community-->
        ...
        <script src="Market_Farmigo Food Community/inspectlet.js" id="inspsync" async="" type="text/javascript"></script>          
        <script src="Market_Farmigo Food Community/pd9trnhx" async="" type="text/javascript"></script>            
        <script style="" src="Market_Farmigo Food Community/fbevents.js" async=""></script>
        <script src="Market_Farmigo Food Community/roundtrip.js" async="" type="text/javascript"></script>
        <script src="Market_Farmigo Food Community/gtm.js" async=""></script>
    ...
    <script src="Market_Farmigo Food Community/js" data-requiremodule="https://maps.google.com/maps/api/js?v=3&amp;libraries=geometry&amp;callback=gmapsLoaded&amp;key=AIzaSyAfANpgkDJZ9xA6_PeUIy0PhJbC75OMruc" data-requirecontext="_" async="" charset="utf-8" type="text/javascript"></script>
    <script src="Market_Farmigo Food Community/SELO23IX2NEGTPTHWLNOAI" type="text/javascript" async="true"></script>
    <script src="Market_Farmigo Food Community/common.js" charset="UTF-8" type="text/javascript"></script>
    <script src="Market_Farmigo Food Community/map.js" charset="UTF-8" type="text/javascript"></script>
    <script src="Market_Farmigo Food Community/util.js" charset="UTF-8" type="text/javascript"></script>
    <script src="Market_Farmigo Food Community/geocoder.js" charset="UTF-8" type="text/javascript"></script>
    <script src="Market_Farmigo Food Community/marker.js" charset="UTF-8" type="text/javascript"></script>
    <div style="width: 1px; height: 1px; display: inline; position: absolute;">
        <img style="border-style:none;" alt="" src="Market_Farmigo Food Community/out_004.gif" height="1" width="1"></div>
    <div style="width: 1px; height: 1px; display: inline; position: absolute;">
        <img style="border-style:none;" alt="" src="Market_Farmigo Food Community/out.gif" height="1" width="1">
        <img style="border-style:none;" alt="" src="Market_Farmigo Food Community/out_002.gif" height="1" width="1">
        <img style="border-style:none;" alt="" src="Market_Farmigo Food Community/out_003.gif" height="1" width="1">
        <img style="border-style:none;" alt="" src="Market_Farmigo Food Community/out_007.gif" height="1" width="1">
        <img style="border-style:none;" alt="" src="Market_Farmigo Food Community/out_008.gif" height="1" width="1">
        <img style="border-style:none;" alt="" src="Market_Farmigo Food Community/out_005.gif" height="1" width="1">
        <img style="border-style:none;" alt="" src="Market_Farmigo Food Community/out_006.gif" height="1" width="1">
    </div>
    ...
    <section id="main-region">
        ...
        <div id="shares">
            ...
            <div class="container widgets-container">
                ...
                <%@page import="com.test.entity_lifecycle.Producteur"%>
                ...
                <%
                    ...
                    List<Producteur> listProducteurs = appDao.listerProducteur();

                    pageContext.setAttribute("listProducteurs", listProducteurs);
...
<h3 class="shares-title">Listes des Producteurs</h3>
                    <%------------------------------------------------------------------------------------------------------------------%>
                                    ...
                                    <div class="table">          
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach var="producteur" items="${pageScope.listProducteurs  }"> 
                                                ...
                                                <td>
                                                    <div class="item-box custom">
                                                        ...
                                                        <div class="items-container">                                                                 
                                                            <div class="share " data-key="${ producteur.id_producteur  }">
                                                                <a>
                                                                    <div class="picture">

                                                                        <img src="${ producteur.photo  }" class="share-picture img-responsive " alt="Photo of Wild Bristol Bay Sockeye Salmon Fillet Value Pack, Frozen">
                                                                        ...
                                                                        <div class="labels-wrapper">
                                                                            ...
                                                                            <div class="share-label discount">
                                                                                <i class="sale-icon"></i>
                                                                                <span class="text">${ producteur.nom  }</span>
                                                                            </div>
                                                                ...
                                                                <div class="details">
                                                                    <div class="details-top ">
                                                                        <div class="details-inner">
                                                                            <div class="">
                                                                                <a class="title ">
                                                                                    <span data-automation-id="share-title" class="text">${ producteur.nom}</span>
                                                                                </a>
                                                                            </div>
                                                                                ...
                                                                                <li class="">
                                                                                    <a href="ServletController?cmd=Producteur_Farmigo Food Community.jsp&commande=Market_01" class="market nav-option active">
                                                                                        <div>
                                                                                            <i class="hidden-xs"></i>
<!--                                                                                            <span class="text">Market</span>-->
                                                                                        </div>
                                                                            ...
                                                                            <a data-automation-id="producer" class="producer-link">
                                                                                <div class="bottom-title">
                                                                                    <span class="arrow hidden-xs">${ producteur.adresse }</span>
                                                                                </div>
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                                ...
                                                                                <li class="">
                                                                                    <a href="ServletController?cmd=Producteur_Farmigo Food Community.jsp&commande=Market_01" class="market nav-option active">
                                                                                        <div>
                                                                                            ...
                                                                                            <button type="submit" class="button add-btn add pull-right"><span class="text">Voir Profil</span></button>
...
<!--                                                                                </form> -->
            ...
            <%------------------------------------
                                         ...
                                         <div class="container widgets-container">
                                             ...
                                             <%@ page import="com.test.lifecycle.AppDAO,com.test.lifecycle.AppDaoImpl,com.test.lifecycle.DaoFactory,java.util.List,com.test.entity.Produit" %>
                                             <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>   
                                             ...
                                             <%  
                                                 ...
                                                 //AppDAO appDao =  AppDaoImpl.getInstanceSingleton(DaoFactory.getInstance());
                                                 List<Produit> listProduits = appDao.listerProduits(id_famille);
                                                                 ...
                                                                 <div class="row">
                                                                     <div class="shares-title-wrapper">
                                                                         <div class="shares-title-container clearfix">
                                                                             ...
                                                                             <div class="title col-xs-9 vbottom">
                                                                                 <h3 class="shares-title"> List Produits !</h3>
                                                                                             ...
                                                                                             <div class="details">
                                                                                                 ...
                                                                                                 <div class="row price-and-quantity">
                                                                                                     ...
                                                                                                     <div data-automation-id="quantity" class="share-quantity col-sm-4 vcenter-sm">
                                                                                                         <div>
                                                                                                             <form method="POST" action="ServletController">
                                                                                                                 <input type="hidden" name="commande" value="MyBagButtonAdd" id="commande" />
