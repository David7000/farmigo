        ...
        <div id="shares">
            ...
            <div class="container widgets-container">
                ...
                <div id="region-favorites-items" class="">
                    ...
                    <%= session.getAttribute("nom")%> , <%= session.getAttribute("prenom")%>, <%= session.getAttribute("login")%> 
                        ...
                        <form  method="post"  action="ServletController">
                            ...
                            <table border="0" width="35%" align="center">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="emailTo" value="saisaisir votre mail"   size="49"/></td>
                                </tr>
                                <tr>
                                    <td>Subject </td>
                                    <td><input type="text" name="subject" value=" <%= session.getAttribute("login")%>" size="49"/></td>
                                </tr>
                                <tr>
                                    <td>Content </td>
                                    <td><textarea rows="10" cols="47" name="content" value="content"></textarea> </td>
                                </tr>
                                <tr>
