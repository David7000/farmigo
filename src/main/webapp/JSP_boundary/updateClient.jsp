        ...
        <div id="shares">
            ...
            <div class="container widgets-container">
                ...
                <div id="region-favorites-items" class="">
                    ...
                    <form method="post" action="ServletController">
                        <input type="hidden" name="commande" value="updateClient" id="commande" />
                        ...
                        <p>
                            ...
                            <input type="text" name="adresse" value="<%= request.getAttribute("adresse")%>" id="adresse" />
                        </p>
                        <p>
                            <label for="telephone">telephone : </label>
                            <input type="text" name="telephone"  value="<%= request.getAttribute("telephone")%>" id="telephone" />
                        </p>    
