...
<!-- Mirrored from www.farmigo.com/about by HTTrack Website Copier/3.x [XR&CO'2010], Sat, 25 Jun 2016 16:54:47 GMT -->
		...
		<ul style='display: none;'>
            ...
            <nav>
                <ul id="nav">
                        ...
                        <li class="help-col">
                            <a id="help" href="index.jsp" target="_blank">Help</a>
                        </li>
...
<nav class="about-nav group">
	<div class="centered">
		<ul>
				...
				<li selected >
					<a href="about/mission.jsp">
						About
					</a>
				</li>
			
				<li  >
					<a href="about/team.jsp">
						Team
					</a>
				</li>
			
				<li  >
					<a href="about/press.jsp">
						Press
					</a>
				</li>
			
				<li  >
					<a href="about/jobs.jsp">
						Jobs
					</a>
				</li>
