...
<!-- Mirrored from www.farmigo.com/benefits by HTTrack Website Copier/3.x [XR&CO'2010], Sat, 25 Jun 2016 16:54:47 GMT -->
...
<script>
	...
	Farmigo.common.data.page = 'Benefits';
...
<script>
	...
	Farmigo.com.data.currentPage = 'benefits';
</script>
...
<body id="page-benefits" class="not-mobile desktop ">
...
<div class="page-start">
	<section class="banner-section banner-section-with-forms work-place">
		<div class="centered">
            <div class="forms">
                <div class="message">
                    <div class="top">
                        
                            <h1>Farm-to-office<br/>groceries delivered</h1>
                            <h2>A <em>no-cost wellness benefit</em> for your<br>employees' health and efficiency</h2>
                        ...
                        <fieldset>
                            ...
                            <div class="fields">
                                ...
                                <div class="form-field">
                                    ...
                                    <input type="text" id="companyName" form-type="name"  placeholder="e.g. Smith inc." error="Please enter company name" mandatory/>
                                </div>
            ...
            <ul>
                <li class="">
                    <figure>
                        ...
                        <figcaption>
                            <p class="big">Good for your business</p>
                            <p>No-cost wellness benefit</p>
                            <p>Easy to get started, no ongoing management required</p>
                            <p>Healthy employees makes healthy business</p>
                            <p>Strengthen community ties by supporting local farms and food producers</p>
                        </figcaption>
                    </figure>
                </li>
                <li class="">
                    <figure>
                        ...
                        <figcaption>
                            <p class="big">Good for your people</p>
                            <p>Employee order from a large selection of the best local veggies, fruit, meat, dairy, and other foods</p>
                            <p>No commitment to order - they order what they want, when they want, with no delivery or membership fees</p>
                            <p>The freshest, most delicious food, grown just hours away and harvested-to-order</p>
                            <p>Time saver - no additional stops at the grocery store</p>
                        </figcaption>
                    </figure>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li >
                    <figure>
                        ...
                        <figcaption>
                            <p class="big"><em>Employees order amazing local food in our online marketplace</em>: fresh produce, eggs and dairy, meats and seafood, breads, pasta, and more!</p>
                        </figcaption>
                    </figure>
                </li>
                ...
                <li >
                    <figure>
                        ...
                        <figcaption>
                            <p class="big">On delivery day, <em>employees pick up their groceries at your office!</em></p>
                        </figcaption>
                    </figure>
                </li>
...
<section class="pr-section">
    ...
    <section class="bottom-forms-section work-place">
        <div class="centered">
        </div>
    </section>
